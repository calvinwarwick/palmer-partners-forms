    ...
    <Card className="border-2 border-orange-200 bg-gradient-to-br from-orange-50 to-white shadow-sm hover:shadow-md transition-all duration-300">
      <CardContent className="p-4 md:p-6">
        <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
          <div className="p-3 bg-orange-500 rounded-lg self-center md:self-start shrink-0">
            <Users className="h-5 w-5 md:h-6 md:w-6 text-white" />
          </div>
          <div className="flex-1 w-full space-y-3 md:space-y-4">
            <div className="text-center md:text-left">
              <Label htmlFor="applicantCount" className="text-base md:text-lg font-semibold text-dark-grey mb-2 block">
                How many adults will be living in the property? <span className="text-red-500">*</span>
              </Label>
              <p className="text-xs md:text-sm text-gray-600 mt-1">Please ensure you provide details for each applicant below.</p>
            </div>
