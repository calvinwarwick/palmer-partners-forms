...
import { Shield, FileText, PenTool, ChevronDown } from "lucide-react";
...
const TermsAndDataStep = ({ 
  ...
  return (
    <div className="space-y-8">
      ...
      <Card className="bg-gradient-to-br from-white to-orange-50/30" style={{ boxShadow: 'rgba(0, 0, 0, 0.12) 0px 1px 3px, rgba(0, 0, 0, 0.24) 0px 1px 2px' }}>
        ...
        <CardContent className="space-y-6 p-6">
          <div className="relative">
            <div 
              ...
              className="max-h-96 overflow-y-auto p-4 border rounded-lg bg-gray-50 text-sm custom-scrollbar relative" 
            ...
            {showScrollIndicator && (
              <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 pointer-events-none transition-opacity duration-500">
