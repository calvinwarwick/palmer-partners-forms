...
const StepIndicator = ({
  ...
  if (isMobile) {
    return <div className="flex items-center justify-center mt-6 pt-4 border-t border-gray-200">
        <div className="flex items-center gap-4 bg-gradient-to-r from-orange-50 to-orange-100 px-4 py-4 rounded-2xl border border-orange-200">
