            ...
            <CardContent className="space-y-4 md:space-y-6 p-4 md:p-6">
              ...
              <div className="space-y-4 md:space-y-6 border-t border-gray-200 pt-4 md:pt-6">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 md:gap-4">
                  <Label htmlFor={`ukPassport-${applicant.id}`} className="text-sm md:text-base font-medium text-gray-700 leading-relaxed">
                ...
                <div className="space-y-3 md:space-y-4">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 md:gap-4">
                    <Label htmlFor={`adverseCredit-${applicant.id}`} className="text-sm md:text-base font-medium text-gray-700 leading-relaxed">
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 md:gap-4">
                  <Label htmlFor={`guarantorRequired-${applicant.id}`} className="text-sm md:text-base font-medium text-gray-700 leading-relaxed">
